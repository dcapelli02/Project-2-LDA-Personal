...
proc glimmix data = alzheimer_long_centered method=QUAD(QPOINTS=10);
    ...
    model CDRSB_CAT(descending) = TIME SEX AGE_STD BMI_STD ADL ABPET_STD TAUPET_STD 
          TIME * AGE_STD TIME * BMI_STD TIME * ADL TIME * ABPET_STD TIME * TAUPET_STD TIME * SEX
